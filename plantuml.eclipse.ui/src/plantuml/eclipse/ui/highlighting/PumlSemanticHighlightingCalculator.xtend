	...
	override provideHighlightingFor(XtextResource resource, IHighlightedPositionAcceptor acceptor, CancelIndicator cancelor) {
		...
		for(contents = resource.getAllContents(); contents.hasNext(); ) 
        {
            ...
            if (element instanceof Class){
            	...
            	highlightNode(element, PumlPackage.Literals.CLASS__ADVANCED_BODY, PumlHighlightingConfiguration.NOTE_ID, acceptor)
            }
            ...
            if (element instanceof NoteClass){
            	highlightNode(element, PumlPackage.Literals.NOTE_CLASS__NOTE_OF, PumlHighlightingConfiguration.CLASS_ID, acceptor)
            	highlightNode(element, PumlPackage.Literals.NOTE_CLASS__VALUE, PumlHighlightingConfiguration.NOTE_ID, acceptor)
            }
